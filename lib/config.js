...
module.exports = {
  raw,
  externalConfig: raw.external_config === true,
  defaultView: raw.default_view === 'off' ? null : raw.default_view === 'recent' ? 'recent' : 'grouped',
  detailRows: raw.detail_rows === true,
  preferPaneLabels: raw.prefer_pane_labels === true,
  parseToml,
  STATIC_GLYPH,
  userGlyph,
  FRAMES,
